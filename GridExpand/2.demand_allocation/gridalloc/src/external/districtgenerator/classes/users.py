...
import src.external.districtgenerator.functions.heating_profile_5R1C as heating
...
class Users:
    ...
    def __init__(self, building_features, area):
        ...
        # self.annual_el_demand = building_features["demand_tot"]
        # self.annual_el_demand_per_flat = np.array(building_features["demand_per_flat"])
